...
@dp.table(
name="riskpulse.bronze.risk_watchlist"
,comment="Risk watchlist raw stream data ingested by auto loader"
)
def fraud_watchlist_bronze() -> DataFrame:
    ...
    streaming_df=(spark.readStream
              ...
              .load("/Volumes/riskpulse/source/risk_watchlist/source_data/")
    )
